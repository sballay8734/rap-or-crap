...
export default function ScoreboardModal() {
  ...
  const children = (
    ...
    >
      ...
      >
        <div className="header flex flex-col items-center justify-center gap-2 h-1/4 bg-red-500">
        ...
        <div className="players flex-grow bg-red-800">
          {players &&
