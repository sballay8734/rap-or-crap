      ...
      <div className="flex flex-col items-center w-full min-w-[60%] justify-between px-2">
        <div className="statsTop flex items-center w-full justify-between bg-secondary/20 px-2 py-1 rounded-md flex-grow">
          <h2 className="flex items-center gap-1">
            <span className="text-[.7rem] text-[#c4c4c4] font-light">
              Correct:
            </span>
            <span className="text-[.7rem] text-green-400">
              {playerData.cCorrect}
            </span>
          </h2>
          <h2 className="flex gap-1 items-center">
            ...
            <span className="text-[.7rem] text-red-400">
              {playerData.cWrong}
            </span>
          </h2>
          <h2 className="flex gap-1 items-center min-w-10">
            ...
            <span
              className={`text-[.7rem] ${handleColor(Number(pctCorrect)).text}`}
            >
